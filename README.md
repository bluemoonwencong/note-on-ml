...
- cs是目前比较热的一个专业
- 自身是属于那种喜欢宅的人，也希望找一个宅一点的工作

bluove说

- 早就该转的，为什么目光如此短浅。
  - phd-postphd-faculty太耗费时间
  - 教授的生活方式也不是我喜欢的
  - 科研领域的成就自己能掌握的因素只占少数
  - 实验狗数理基础只会越来越废最终只会写本子切硅片镀膜烧炉子过柱子在社会上毫无生存能力
  - 至于英文写作阅读演讲口才什么的只是副产品
  - 至于薪水我看就不必说了因为明年我就月薪远远大于现在的年薪了
- 所以为什么不转CS呢。
- CS大法好，退物保平安。
...
- 最好的书有那么几本，西瓜书，李航统计，PRML，花书。
- 最好的课程也有几个，吴恩达，台大，CS231n。
- 最好的文档当然是官方文档了，写得超详细，竟还有翻译版。
- 也有一些盗版视频资源，七月在新，小象学院，优达学城。
- 作为非计算机专业/数学出身，得拿到比名校计算机毕业证更好的证明，就只有一个选项了 - kaggle/天池。

1. 应该是，ML ---> DL。
2. 先学会ML的各种基本模型，会推导，会调包，比如各种广义线性模型，决策树和随机森林，svm，聚类，隐马尔科夫链，条件随机场。
3. 还有ML的常规技术，交叉验证，判断过拟合欠拟合，特征工程，等。
4. 然后再完成kaggle和天池的新手入门项目。
   但是，就这样，就行了吗，这样就够了吗？
   就这样，就行了吗，就够了吗？
   好担心好害怕啊
   ......
...
- 斯坦福， 《CS231n: Convolutional Neural Networks for Visual Recognition Spring 2018》 Previous Years: Winter 2015 [Spring 2017]
...
- PRML绪论及后面习题
- 李航统计前7章，详细的笔记
- 通过查阅西瓜书，林轩田机器学习基石部分课程，其它资料，理解VC维，在白纸上用自己的话解释VC维。
- 看几篇综述性质的DL文章
...
- 纯python实现上述三种算法
- 有精力的话，小象学院机器学习VII，七月在线机器学习，看完一半内容。
- ​

（本周任务聚焦在书本。 code任务只有两个的话应该没问题；PRML提前已经看过题目了的；总之，这周应该能完美完成吧。）

结果：

- 棒棒：
  - 看完理论内容，但是印象不够深刻
  - 纯python实现朴素贝叶斯、决策树ID3，C4.5，CART
  - 部分实现随机森林，独自完成代码有点吃力（参考别人的代码）
  - 部分实现ada_boost，独自完成代码有点吃力（参考别人的代码）
  - **还需要更加努力才行，否则很难真正掌握机器学习**
